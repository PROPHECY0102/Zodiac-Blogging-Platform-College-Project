...
<body class="bg-amber-50">
  <header class="w-full grid place-items-center gap-4 py-8">
    ...
    <div class="flex items-center">
      <a href="/" class="font-bold text-4xl hover:underline">ZODIAC</a>
    </div>
    <div class="w-full">
      <h1 class="font-bold text-4xl text-center">Admin Dashboard Panel</h1>
    </div>
    <div class="w-full flex justify-center items-center gap-4 text-2xl font-medium">
      <a class="hover:underline" href="/dashboard/users">Manage Users</a>
      <span>|</span>
      <a class="hover:underline" href="/dashboard/categories">Manage Categories</a>
      <span>|</span>
      <a class="hover:underline" href="/dashboard/blogposts">Manage Blogs</a>
    </div>
  </header>
